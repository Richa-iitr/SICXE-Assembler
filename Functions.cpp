//Helper functions for converting assembler's pass1 and pass2
#include<bits/stdc++.h>
using namespace std;
...
void firstNonWhiteSpace(string line,int& index,bool& status,string& data,bool readTillEnd=false){
  data = "";
  status = true;
  if(readTillEnd){
...
char getOperandFormat(string data){
